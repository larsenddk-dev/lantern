...
// Cmd/Ctrl + 1..9 jump targets (mirrors the nav sidebar order; the rest reachable via search).
const NAV_PATHS = ["/chat", "/agent", "/research", "/compare", "/documents", "/notes", "/tasks", "/memory", "/prompts"];
