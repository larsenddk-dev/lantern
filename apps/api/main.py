...
COOKBOOK_CATALOG: list[dict] = [
    ...
    # --- Vision models (drag images into chat) ---------------------------
    {"id": "moondream:latest", "name": "Moondream 1.8B", "size_gb": 1.7,
     "min_ram_gb": 4, "recommended_ram_gb": 8, "tags": ["vision", "tiny"],
     "description": "Tiniest vision model — runs anywhere, reads basic images."},
    {"id": "llava-phi3:latest", "name": "LLaVA-Phi3 3.8B", "size_gb": 2.9,
     "min_ram_gb": 6, "recommended_ram_gb": 8, "tags": ["vision", "small"],
     "description": "Compact vision model. Good for screenshots and quick reads."},
    {"id": "llava:7b", "name": "LLaVA 7B", "size_gb": 4.7,
     "min_ram_gb": 8, "recommended_ram_gb": 16, "tags": ["vision"],
     "description": "Classic vision model. Send an image and ask about it."},
    {"id": "llama3.2-vision:11b", "name": "Llama 3.2 Vision 11B", "size_gb": 7.9,
     "min_ram_gb": 12, "recommended_ram_gb": 16,
     "tags": ["vision", "popular"],
     "description": "Meta's modern vision model. Strong general image understanding."},
    {"id": "qwen2.5vl:7b", "name": "Qwen 2.5-VL 7B", "size_gb": 6.0,
     "min_ram_gb": 10, "recommended_ram_gb": 16,
     "tags": ["vision", "reasoning"],
     "description": "Multimodal Qwen — sharp at reading text inside images."},
